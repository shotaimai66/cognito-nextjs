import { HttpPrivateIntegrationOptions } from 'aws-cdk-lib/aws-apigatewayv2-integrations/lib/http/base-types';
import { HttpPrivateIntegration } from 'aws-cdk-lib/aws-apigatewayv2-integrations/lib/http/private/integration';
