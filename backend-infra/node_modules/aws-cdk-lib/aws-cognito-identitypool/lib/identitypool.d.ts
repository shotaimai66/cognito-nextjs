...
import { IUserPoolAuthenticationProvider } from 'aws-cdk-lib/aws-cognito-identitypool/lib/identitypool-user-pool-authentication-provider';
import { CfnIdentityPoolRoleAttachment, IUserPool, IUserPoolClient } from 'aws-cdk-lib/aws-cognito';
