...
import { CfnLoadBalancer } from 'aws-cdk-lib/aws-elasticloadbalancing/lib/elasticloadbalancing.generated';
import { Connections, IConnectable, Instance, ISecurityGroup, IVpc, Port, SubnetSelection } from 'aws-cdk-lib/aws-ec2';
