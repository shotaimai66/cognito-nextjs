...
import { Alias } from 'aws-cdk-lib/aws-kms/lib/alias';
import { KeyLookupOptions } from 'aws-cdk-lib/aws-kms/lib/key-lookup';
import { CfnKey } from 'aws-cdk-lib/aws-kms/lib/kms.generated';
...
export declare class Key extends KeyBase {
     ...
     */
    static isLookupDummy(key: IKey): boolean;
    readonly keyArn: string;
    readonly keyId: string;
