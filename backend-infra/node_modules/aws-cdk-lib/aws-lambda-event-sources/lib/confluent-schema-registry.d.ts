import { IEventSourceMapping, IFunction } from 'aws-cdk-lib/aws-lambda/lib';
import { ISchemaRegistry, KafkaSchemaRegistryAccessConfigType, KafkaSchemaRegistryConfig, SchemaRegistryProps } from 'aws-cdk-lib/aws-lambda/lib/schema-registry';
