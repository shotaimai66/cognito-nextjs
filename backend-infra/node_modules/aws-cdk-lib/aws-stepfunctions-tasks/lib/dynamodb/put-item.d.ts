...
import { DynamoAttributeValue, DynamoConsumedCapacity, DynamoItemCollectionMetrics, DynamoReturnValues } from 'aws-cdk-lib/aws-stepfunctions-tasks/lib/dynamodb/shared-types';
