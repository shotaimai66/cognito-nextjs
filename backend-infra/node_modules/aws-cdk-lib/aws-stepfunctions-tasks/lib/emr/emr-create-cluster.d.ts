...
export declare class EmrCreateCluster extends sfn.TaskStateBase {
     ...
     */
    static jsonPath(scope: Construct, id: string, props: EmrCreateClusterJsonPathProps): EmrCreateCluster;
    /**
     * A Step Functions task using JSONata to create an EMR Cluster.
     *
     * This task creates a Lambda function to call cross-region AWS API and invokes it.
     */
    static jsonata(scope: Construct, id: string, props: EmrCreateClusterJsonataProps): EmrCreateCluster;
